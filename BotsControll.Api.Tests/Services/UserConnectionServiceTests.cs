...
public class UserConnectionServiceTests
{
    ...
    {
        var user = new UserIdentity(1, "123", "email", new List<RoleDto>());
    ...
    {
        var user = new UserIdentity(1337, "user_name", "email", new List<RoleDto>());
    ...
    {
        var user = new UserIdentity(12, "user_name", "email", new List<RoleDto>());
    ...
    {
        var user1 = new UserIdentity(12, "user_name1", "email", new List<RoleDto>());
        var user2 = new UserIdentity(51, "user_name2", "email", new List<RoleDto>());
